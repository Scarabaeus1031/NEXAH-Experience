...
export const editorialDoors = [
  {
    ...
    description: "The emerging foundation program for orientation, design, theory and architecture.",
  ...
  },
  {
    ...
    description: "Visual atlases, field maps and representational systems across many scales.",
